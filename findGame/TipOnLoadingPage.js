...
$(document).ready(function() {
    ...
    var tips = [
        ...
        "Meet TagPro players on our <a href='https://reddit.com/r/tagpro/wiki/discord'>Discord</a> voice-chat servers. Microphone not required.",
    ...
    function placeTip() {
        ...
        var headText = $("<div id='tip' style='margin-top: 20px;text-align: left;'></div>")
            ...
            .wrapAll("<div class='row'><div class='col-xs-12'></div></div>");
